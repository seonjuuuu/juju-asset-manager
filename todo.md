...
- [x] 기본 카테고리 시드 데이터 삽입
- [x] db.ts 카테고리 CRUD 헬퍼 추가
- [x] tRPC categories 라우터 추가 (list, addMain, updateMain, deleteMain, addSub, updateSub, deleteSub)
- [x] 카테고리 관리 페이지 UI 구현
- [x] 가계부 입력 다이얼로그 카테고리 목록 연동
- [x] 사이드바 메뉴에 카테고리 관리 추가
